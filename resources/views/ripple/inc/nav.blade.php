...
<nav class="w-full fixed top-0 py-2 bg-[#151111] border-gray-200 z-30">
    <div class="container mx-auto px-4 md:px-8 xl:px-40 flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div class="hidden md:flex items-center ml-5" id="desktop-menu">
                <ul class="flex flex-row md:text-sm bg-[#151111]">
    ...
    <div class="hidden w-full md:hidden" id="mobile-menu">
        <ul class="flex flex-col text-sm bg-[#151111] p-4">
            @foreach ($menu as $item)
                <li class="mr-6 my-2 md:my-0 dropdown relative group">
                    @if (count($item['children']))
                        <button data-dropdown-toggle="nav-dropdown-{{ $loop->index }}"
